...
\begin{figure*}%[ht]
  \begin{center}
    \includegraphics[width=3.2in]{graphs/densityForce_ppext=0_new.eps}
    \includegraphics[width=3.2in]{graphs/densityForce_fracErr_ppext=0_new.eps}
    \includegraphics[width=3.2in]{graphs/densityForce_ppext=0_rebin_new.eps}
    \includegraphics[width=3.2in]{graphs/densityForce_fracErr_ppext=0_rebin_new.eps}
    \includegraphics[width=3.2in]{graphs/densityForce_ppext=0_rebin_N10_new.eps}
