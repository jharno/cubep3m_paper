...
{\bf In terms of memory, {\small CUBEP$^3$M} can be configured such as the main footprint is dominated exclusively by the 
...
A higher number of cells per tile with fewer tiles usually run faster, in which case the other arrays in the above-mentioned list become memory heavy.
%
%uses about $130 - 150$ bytes per particles, and is in that sense more heavy than other codes like the 
For comparison, Lean-{\small GADGET-2} code uses  $84$ per particles \citep{Gadget2Lean}.}
...
{\bf A recent adjustment of the similar kind was also applied on the fine kernel to compensate for a systematic underestimate of the force at grid distances.
...
\includegraphics[width=5.2in]{graphs/0.000proj_1000x1000.eps}
  \caption{Detail of a dark matter density $3.2 h^{-1}\mbox{Gpc}$Êper side, projected over $15 h^{-1}\mbox{Mpc}$ and measured at $z=0$ in a RANGER4000 simulation.
...
\begin{figure*}%[ht]
 ...
 %   \includegraphics[width=3.0in]{graphs/densityForce_ppext=0_new-1.eps}
   % \includegraphics[width=3.0in]{graphs/densityForce_fracErr_ppext=0_new.eps}
    \includegraphics[width=3.0in]{graphs/densityForce_ppext=0_new_kern.eps}
    \includegraphics[width=3.0in]{graphs/densityForce_fracErr_ppext=0_new_kern.eps}
    %\includegraphics[width=3.0in]{graphs/densityForce_ppext=0_rebin_new-1.eps}
   \includegraphics[width=3.0in]{graphs/densityForce_ppext=0_rebin_new_kern.eps}
   \includegraphics[width=3.0in]{graphs/densityForce_fracErr_ppext=0_rebin_new_kern.eps}
 %   \includegraphics[width=3.0in]{graphs/DeltaF_pp0.eps}
   \includegraphics[width=3.0in]{graphs/densityForce_ppext=0_rebin_new_kern_N10.eps}
   \includegraphics[width=3.0in]{graphs/densityForce_fracErr_ppext=0_rebin_new_kern_N10.eps}
...
local volume. {\bf Each {\small MPI} sub-volume generates its own random seed, 
which are used to create a local noise map. The initial power spectrum is found by reading off a transfer function that is by default generated from {\small CAMB}, 
