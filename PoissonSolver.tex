...
for the fine grid \citep{1981csup.book.....H}. Particle-particle interactions are not interpolated, 
but we instead impose a sharp cutoff on the force
for pairs that air closer than a tenth of a grid cell. 
