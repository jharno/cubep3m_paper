...
only the head processor is active. Other libraries such as {\small P3DFFT} \citep{p3dfft} or  Intel {\small MKL-$\alpha$} \citep{fft_mkl} currently permit this extra level of parallelization,
